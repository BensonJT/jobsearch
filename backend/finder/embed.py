...
def load_encoder(backend: Optional[str] = None, model_name: str = EMBED_MODEL):
...
def vectors_json(vecs) -> str:
    """A JSON array of float lists (5 decimals) for DuckDB's json_transform -> FLOAT[] -> FLOAT[384]."""
    import numpy as np
